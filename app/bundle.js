...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/avenuecode/Repos/react-canvas-game/app/src/components/index.jsx */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myCanvas = __webpack_require__(/*! ./myCanvas */ 169);
	
	var _myCanvas2 = _interopRequireDefault(_myCanvas);
	
	var _popup = __webpack_require__(/*! ./popup */ 171);
	
	var _popup2 = _interopRequireDefault(_popup);
	
	var _store = __webpack_require__(/*! ../store.js */ 172);
	
	var _store2 = _interopRequireDefault(_store);
	
	var _actions = __webpack_require__(/*! ../actions.js */ 192);
	...
	var App = function (_Component) {
	  ...
	  function App() {
	    ...
	    _store2.default.listen(function () {
	      return _this.onGameStateChange(_store2.default.gameState);
	    });
	
	    _this.state = { gameState: _store2.default.gameState };
	  ...
	  _createClass(App, [{
	    ...
	    value: function onGameStateChange(status) {
	      //console.log(this);
	    ...
	    value: function handlePopupClick(arg) {
	      console.log('click : ' + arg);
	      if (arg === 'start') {
	        console.log(_actions2.default);
	        _actions2.default.startGame();
	      } else if (arg === 'end') {
	        _actions2.default.endGame();
	      }
	    }
	  }, {
	    key: 'showPopup',
	    value: function showPopup() {
	      ...
	      return _react2.default.createElement(_popup2.default, { headerTitle: title, className: className,
	        buttonText: text, whenClicked: function whenClicked() {
	          return _this2.handlePopupClick(status);
	        } });
	    }
	  }, {
	    key: 'loadContent',
	      ...
	      if (this.state.gameState === 'start') {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'info' },
	            'Use[A], [D] --- [←], [→] to MOVE Circles '
	          ),
	          _react2.default.createElement(_myCanvas2.default, null)
	        );
...
/* 169 */
/*!*****************************************!*\
  !*** ./app/src/components/myCanvas.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _circle2 = __webpack_require__(/*! ./circle */ 170);
	...
	module.exports = function (_Component) {
	  ...
	  function MyCanvas() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MyCanvas).call(this));
	  ...
	  _createClass(MyCanvas, [{
	    ...
	    value: function handleKeyDown(e) {
	      ...
	      var velocity = this.state.circle1.velocity;
	      ...
	      if (e.keyCode === this.state.circle1.key.left) {
	        ...
	        var _circle = this.state.circle2;
	        if (_circle.position.x + _circle.radius < this.state.screen.width) {
	          _circle.position.x += velocity;
	    ...
	    value: function start() {
	      this.circle1 = new _circle3.default(this.state.circle1);
	      this.circle2 = new _circle3.default(this.state.circle2);
	    }
	  }, {
	    key: 'update',
	    ...
	    key: 'checkStatus',
	    value: function checkStatus(arg1, arg2) {
	      var diff = arg1.position.x + arg1.radius - (arg2.position.x + arg2.radius);
	    ...
	    key: 'getCircle2Position',
	    value: function getCircle2Position() {
	      var objX = this.state.circle1.position.x;
	      var objY = this.state.circle1.position.y;
	
	      var curX = this.state.circle2.position.x;
	      var curY = this.state.circle2.position.y;
	      var circle2 = this.state.circle2;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ className: 'close' },
						' ',
						_react2.default.createElement('input', { type: 'button', value: this.props.buttonText, onClick: this.props.whenClicked }),
						' '
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(/*! reflux */ 173);
	var gameActions = __webpack_require__(/*! ./actions.js */ 192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = Reflux.createActions(['startGame', 'endGame']);
