...
/***/ function(module, exports, __webpack_require__) {
	...
	var _circle5 = __webpack_require__(/*! ./circle */ 170);
	...
	module.exports = function (_Component) {
	  ...
	  _createClass(MyCanvas, [{
	    ...
	    value: function handleKeyDown(e) {
	      ...
	      if (e.keyCode === this.state.circle1.key.left) {
	        ...
	        if (circle1.position.x - circle1.radius > 0) {
	          var _circle = this.state.circle1;
	          _circle.position.x -= 3;
	        ...
	        var _circle2 = this.state.circle1;
	
	        if (_circle2.position.x + _circle2.radius < this.state.screen.width) {
	          var _circle3 = this.state.circle1;
	          _circle3.position.x += 3;
	        ...
	        var _circle4 = this.state.circle2;
	        if (_circle4.position.x + _circle4.radius < this.state.screen.width) {
	          _circle4.position.x += 3;
	    ...
	    value: function start() {
	      this.circle1 = new _circle6.default(this.state.circle1);
	      this.circle2 = new _circle6.default(this.state.circle2);
	    }
	  }, {
	    key: 'update',
